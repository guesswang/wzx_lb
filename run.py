...
# 重新创建目录
    ...
    kmax_map = "6 %d %d %d %d %d %d %d %d %d %d %d %d" % (
        bw*50000000, 400, bw*100000000, 400, bw*200000000, 400, bw*300000000, 400, bw*500000000, 400, bw*1000000000, 400)
    kmin_map = "6 %d %d %d %d %d %d %d %d %d %d %d %d" % (
        bw*50000000, 100, bw*100000000, 100, bw*200000000, 100, bw*300000000, 100, bw*500000000, 100, bw*1000000000, 100)
    pmax_map = "6 %d %d %d %d %d %.2f %d %.2f %d %.2f %d %.2f" % (
        bw*50000000, 0.2, bw*100000000, 0.2, bw*200000000, 0.2, bw*300000000, 0.2, bw*500000000, 0.2, bw*1000000000, 0.2)
