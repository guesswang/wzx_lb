...
if __name__ == "__main__":
	...
	parser.add_option("-n", "--nhost", dest = "nhost", help = "number of hosts", default = "127")
	parser.add_option("-l", "--load", dest = "load", help = "the percentage of the traffic load to the network capacity, by default 0.3", default = "0.01")
	parser.add_option("-b", "--bandwidth", dest = "bandwidth", help = "the bandwidth of host link (G/M/K), by default 10G", default = "10G")
	parser.add_option("-t", "--time", dest = "time", help = "the total run time (s), by default 1", default = "0.3")
